...
<div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full">
  <div class="text-center">
    ...
    <h1 class="mt-5 text-[36px] font-bold text-slate-600 lg:text-[50px]">500 - Server error</h1>
    <p class="text-slate-500 mt-5 lg:text-lg">Oops something went wrong. Try to refresh this page or <br/> feel free to contact us if the problem presists.</p>
  </div>
</div> 
    </div>
  )
